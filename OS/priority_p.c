...
void sort_arrival(char name[][20], int arrival_time[], int burst_time[], int priority[], int atc[], int btc[], int exit_time[], int number);

float avg(int burst_time[], int number);

void cpy(int arrival_time[], int burst_time[], int atc[], int btc[], int number);

void sort_priority(char name[][20], int arrival_time[], int burst_time[], int priority[], int atc[], int btc[], int exit_time[], int point);
...
void res(char name[][20], int arrival_time[], int burst_time[], int priority[], int number, int rr_time)
{
    ...
    int exit_time[number], tat[number], wait_time[number], counter_bef = 0, counter_aft = 0, cutoff = 0;
    float av_time;
    int buffer;
    ...
    sort_arrival(name, arrival_time, burst_time, priority, atc, btc, exit_time, number);

loop:

    for (int i = 0; i < number; i++)
    {
        if (atc[i] <= counter_aft)
        {
            cutoff += 1;
        }
    }
    ...
    if (cutoff >= 2)
    {
        sort_priority(name, arrival_time, burst_time, priority, atc, btc, exit_time, cutoff);
    }
    cutoff = 0;
